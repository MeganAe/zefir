...
void main() {
  ...
  group('CompressionResult sérialisation', () {
    test('round-trip toMap/fromMap conserve toutes les données', () {
      ...
      expect(restored.originalSizeBytes, 1000000);
      expect(restored.compressedSizeBytes, 250000);
    ...
    test('round-trip JSON identique', () {
      ...
      expect(restored.savedBytes, 750000);
    });
  ...
  group('HistoryService', () {
    ...
    test('sort applique les critères AppConstants', () {
      ...
      expect(
        HistoryService.sort(records, AppConstants.sortByDateAsc)
            .map((e) => e.id),
        ['a', 'b', 'c'],
      );
      expect(
